  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
         <Button size={'sm'} className="bg-green-500 shimmer text-white hover:bg-green-400">
           <Share2/> Share
          </Button>
      </PopoverTrigger>
      <PopoverContent className="w-80">
        <div className="grid gap-4">
          <div className="space-y-2">
            <h4 className="font-medium text-sm leading-none flex items-center gap-1"> <FaFileExport /> Export</h4>
          </div>
          <div className="grid gap-2 grid-cols-3">
            <Button size={'sm'} className="dark:bg-pink-500 text-white" onClick={()=>exportCanvas('jpg', title)}><PiFileJpgFill/> JPG</Button>
            <Button size={'sm'} className="dark:bg-indigo-500 text-white"><PiFilePngFill/> PNG</Button>
            <Button size={'sm'} className="dark:bg-purple-500 text-white"><PiFileSvgFill/> SVG</Button>
          </div>
